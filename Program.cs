...
namespace Queue_Opgave
{
    class Program
    {
        ...
        static Queue<PrinterJob> newQueue = new Queue<PrinterJob>();
        ...
        static void DeleteItem()
        {
            ...
            newQueue = new Queue<PrinterJob>(newQueue.Where(job => (job.FileName != fileInput && job.FileType != typeInput)));
        ...
        static void ShowNumItems()
        {
            ...
            Console.ReadLine();
            foreach (PrinterJob item in newQueue)
            {
        ...
        static void ShowMinMax()
        {
            ...
            Console.Clear();
            Console.WriteLine($"The Smallest file in the queue {newQueue.Min(job => job.FileSize)}");
            Console.WriteLine($"The Biggest file in the queue {newQueue.Max(job => job.FileSize)}");
            Console.ReadLine();
        }
